...
class AndroidApiController extends MainAPIController
{
    ...
    {   
        ...
        $netsocks_on_off=$settings->netsocks_on_off;
        $netsocks_publisher_key=$settings->netsocks_publisher_key;
        $netsocks_consent=$settings->netsocks_consent;
